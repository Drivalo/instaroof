...
export const PRICE_ESTIMATE_DISCLAIMER =
  "Final price depends on your roof material and condition. Your roofer will confirm on inspection.";
...
export function RoofMaterialComparisonTable({
  ...
  return (
    <div>
      ...
      <p className="mt-2 text-xs text-muted leading-relaxed">{PRICE_ESTIMATE_DISCLAIMER}</p>
    </div>
  );
}
