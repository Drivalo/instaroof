    ...
    <main className="customer-page min-h-[70vh] bg-zinc-50 py-14">
      <section className="container-max">
        <div className="mx-auto max-w-2xl rounded-2xl border border-zinc-200 bg-white p-8 shadow-sm text-center">
          {status === "loading" && (
            <>
              <h1 className="text-3xl text-zinc-900">Confirming payment...</h1>
          ...
          {status === "success" && (
            <>
              ...
              <h1 className="text-3xl text-zinc-900">Payment confirmed!</h1>
          ...
          {status === "error" && (
            <>
              <h1 className="text-3xl text-zinc-900">Payment not confirmed</h1>
          ...
          <Link
            href="/"
            className="mt-8 inline-block rounded-xl bg-[#C8102E] px-6 py-3 text-white"
          >
            Back to Home
          </Link>
        </div>
        ...
        <main className="customer-page min-h-[70vh] bg-zinc-50 py-14">
          <section className="container-max">
            <div className="mx-auto max-w-2xl rounded-2xl border bg-white p-8 text-center">
              <h1 className="text-3xl">Confirming payment...</h1>
            </div>
          </section>
        </main>
      }
